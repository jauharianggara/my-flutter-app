...
class ApiService {
  static const String baseUrl = 'http://localhost:8080'; // Change this to your API URL
  ...
  static const String karyawansWithKantorEndpoint = '$apiPrefix/karyawans/with-kantor';
  static const String karyawansWithPhotoEndpoint = '$apiPrefix/karyawans/with-photo';
  ...
  static Future<ApiResponse<T>> handleResponse<T>(
    ...
    try {
      ...
      if (response.statusCode >= 200 && response.statusCode < 300) {
        return ApiResponse.fromJson(jsonData, (data) => fromJson(data as Map<String, dynamic>));
      } else {
